...
// Lägg till props-typ som accepterar alla standard HTML-attribut
type FooterProps = React.HTMLAttributes<HTMLElement>;

const Footer: React.FC<FooterProps> = (props) => {
  return (
    <footer
      {...props} // <-- här sprider vi role, aria-label och andra attribut
      className="w-full text-sm px-8 py-3 mt-0 bg-gray-900 text-white"
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
        {/* Copyright */}
        <p>© 2024 Your Company LLC</p>
